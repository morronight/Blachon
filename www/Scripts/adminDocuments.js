function adminDocuments_action(a)
{
...
function adminDocuments_update(obj)
{
	...
	var url = '/administration/searchDocuments.php?';
	var categorie;
...
function adminDocuments_selectCategories(val)
{
	var categoriesNodes;
	var categorie;
	...
	adminDocuments_update(null);
}

function adminDocuments_nouveauDocument(a)
{
	var categorie;
	var	categories = new Array();
	var categoriesNodes;
