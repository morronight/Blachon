...
function adminVideos_update(obj)
{
	...
	var url = '/administration/searchVideos.php?';
	var categorie;
...
function adminVideos_selectCategories(val)
{
	var categoriesNodes;
	var categorie;
	...
	adminVideos_update(null);
}

function adminVideos_nouvelleVideo(a)
{
	var categorie;
	var	categories = new Array();
	var categoriesNodes;
