...
<?php
	...
	// oauth2_client_id, oauth2_client_secret, and to register your oauth2_redirect_uri.
	 $client->setClientId(Configuration::$Google['GooglePlus']['ClientId']);
	 $client->setClientSecret(Configuration::$Google['GooglePlus']['ClientSecret']);
	 $client->setRedirectUri(Configuration::$Google['GooglePlus']['RedirectUri']);
	 $client->setDeveloperKey(Configuration::$Google['GooglePlus']['DeveloperKey']);
